...
public interface ApprovalPolicyRepository extends JpaRepository<ApprovalPolicyEntity, Long>,
        JpaSpecificationExecutor<ApprovalPolicyEntity> {
    List<ApprovalPolicyEntity> findByTargetStatusAndModule(String targetStatus,ModuleEnum moduleEnum);

    ApprovalPolicyEntity findByTargetStatusAndRequesterPositionAndModule(String targetStatus,String requesterPosition,ModuleEnum moduleEnum);
}
