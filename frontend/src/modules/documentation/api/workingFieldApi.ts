import { WORKING_FIELD_ENDPOINT } from '@/modules/documentation/constants/api-endpoint';
import axiosClient from '@/lib/axiosClient';
import type { WorkingFieldFormData } from '@/modules/documentation/validations/workingFieldSchema';
