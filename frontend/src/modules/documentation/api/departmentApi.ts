import { DEPARTMENT_ENDPOINT } from '@/modules/documentation/constants/api-endpoint';
import axiosClient from '@/lib/axiosClient';
import type { DepartmentFormData } from '@/modules/documentation/validations/departmentSchema';
