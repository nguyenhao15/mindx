import { useGetAllBasements } from '@/modules/documentation/hookQueries/useBasementHook';
import { toArray } from '@/utils/formatValue';
import type { BasementResponse } from '@/modules/documentation/validations/basementSchema';
