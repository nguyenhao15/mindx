import { useGetPositions } from '@/modules/documentation/hookQueries/usePositionHook';
import type { PositionResponse } from '@/modules/documentation/validations/positionSchema';
